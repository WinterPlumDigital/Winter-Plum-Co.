...
export function FAQ() {
  ...
  return (
    <main className="min-h-screen pt-40 relative overflow-hidden">
      <SEO
        title="Frequently Asked Questions | Winter Plum & Co"
        description="Find answers to common questions about our web design process, pricing, SEO services, and ongoing support."
