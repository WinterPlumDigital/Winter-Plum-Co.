    ...
    return (
        <>
            ...
            <main className="min-h-screen pt-32 pb-20 px-6 relative">
                ...
                <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 mb-32">
                    <div className="group">
                ...
                <section className="max-w-4xl mx-auto bg-[#302928] rounded-[3rem] p-12 md:p-20 text-center text-[#fcf6ee] relative overflow-hidden">
