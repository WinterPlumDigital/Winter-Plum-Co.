...
export function AnimatedPagoda({ className = "" }: { className?: string }) {
  ...
  return (
    <div className={`w-full h-full min-h-[320px] flex items-center justify-center ${className}`}>
      <svg
        viewBox="0 0 400 500"
        preserveAspectRatio="xMidYMid meet"
        className="w-full h-auto max-w-full drop-shadow-xl overflow-visible"
        aria-hidden="true"
      >
        <motion.g custom={0} initial="hidden" animate="visible" variants={buildUp}>
          ...
          >
            ...
            <g transform="translate(90, 450) scale(1.35) translate(-90, -450)">
              ...
              <motion.circle cx="45" cy="410" r="3.5" fill={blush} custom={0} initial="hidden" animate="visible" variants={bloom} />
              <motion.circle cx="55" cy="405" r="4.5" fill={blushLight} custom={1} initial="hidden" animate="visible" variants={bloom} />
              <motion.circle cx="38" cy="400" r="3" fill={blush} custom={2} initial="hidden" animate="visible" variants={bloom} />
            </g>
          </motion.g>
        </motion.g>

        <motion.g custom={1} initial="hidden" animate="visible" variants={buildUp}>
        ...
        <motion.g custom={2} initial="hidden" animate="visible" variants={buildUp}>
        ...
        <motion.g custom={3} initial="hidden" animate="visible" variants={buildUp}>
        ...
        <motion.g custom={4} initial="hidden" animate="visible" variants={buildUp}>
        ...
        <motion.g custom={5} initial="hidden" animate="visible" variants={buildUp}>
